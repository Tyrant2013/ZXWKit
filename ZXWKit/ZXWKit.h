...
//! Project version number for ZXWKit.
FOUNDATION_EXPORT double ZXWKitVersionNumber;

//! Project version string for ZXWKit.
FOUNDATION_EXPORT const unsigned char ZXWKitVersionString[];
